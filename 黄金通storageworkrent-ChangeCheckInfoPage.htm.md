...
```
POST /storagework/rentChangeCheckInfoPage.htm HTTP/1.1
...
Referer: https://113.105.126.146:8900/reportframework/custStorageRentChangeInfoSel.htm
Accept-Encoding: gzip, deflate, br
Accept-Language: zh-CN,zh;q=0.9
Priority: u=1, i
Connection: keep-alive

page=1&origApp2=1&RENTSTATEID=60&clientname=
```

The parameter clientname in the request body is vulnerable to SQL injection.
